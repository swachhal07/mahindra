...
const POSTS = [
  {
    ...
    date: '2026-05-22',
    author: 'Dugar Brothers and Sons Pvt LTD Team',
    category: 'Technology',
  ...
  },
  {
    ...
    body: [
      ...
      "Activation is done at the dealership. If your fleet runs Mahindra and you haven't used DiGiSense yet, bring the vehicle in and we'll set up the account, train the dispatcher, and walk you through the first month of reports.",
    ],
    date: '2026-04-19',
    author: 'Dugar Brothers and Sons Pvt LTD Team',
    category: 'Technology',
