...
// Flat cream, same tone as the textured version. Used on tall sections where
// painting the repeated noise tile costs more than the grain is worth.
export const PAPER_FLAT_STYLE = {
